...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Update data nasabah
    $update_query = "UPDATE nasabah SET 
                        NAMA_NASABAH = '$nama',
                        EMAIL = '$email',
                        NOMER_TELEPON = '$nomer_telepon',
                        ALAMAT = '$alamat',
                        PASSWORD_NASABAH = '$password'
                    WHERE USERNAME_NASABAH = '$username_nasabah'";

    if (mysqli_query($koneksi, $update_query)) {
        echo "<script>alert('Profil berhasil diperbarui.'); window.location.href = 'akun.php';</script>";
    } else {
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Akun</span>
      </a>
    </div>
    ...
    <div class="row">
        ...
        <form method="POST" action="edit_profile.php">
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" value="<?php echo $nasabah['NAMA_NASABAH']; ?>" required>
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="<?php echo $nasabah['EMAIL']; ?>" required>
            </div>
            <div class="form-group">
                <label for="nomer_telepon">Nomor Telepon:</label>
                <input type="text" id="nomer_telepon" name="nomer_telepon" value="<?php echo $nasabah['NOMER_TELEPON']; ?>" required>
            </div>
            <div class="form-group">
                <label for="alamat">Alamat:</label>
                <input type="text" id="alamat" name="alamat" value="<?php echo $nasabah['ALAMAT']; ?>" required>
            </div>
            <div class="form-group">
                <label for="password">Password:</label>
                <input type="password" id="password" name="password" value="<?php echo $nasabah['PASSWORD_NASABAH']; ?>" required>
            </div>
            <div class="form-group">

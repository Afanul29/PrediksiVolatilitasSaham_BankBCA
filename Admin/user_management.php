  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Nasabah</span>
      </a>
    </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Data Nasabah</h6>
        </nav>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>";
                                echo "<a href='update_nasabah.php?id=" . $row['ID_NASABAH'] . "' class='mr-5'><i class='fas fa-edit'></i>
                                </a>";
                                echo "<a href='delete_nasabah.php?id=" . $row['ID_NASABAH'] . "' class='text-danger ml-2'><i class='fas fa-trash'></i></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='6'>Tidak ada data nasabah</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
<script>
    function tambahData() {
        ...
        // Kirim data ke server (Anda perlu mengimplementasikan kode PHP untuk menyimpan data ini ke database)
        // Di sini Anda perlu menggunakan AJAX atau mengirim formulir secara tradisional
        // Misalnya menggunakan metode POST
        // $.post('tambah_data_nasabah.php', { nama: nama, alamat: alamat, email: email, nomor_telepon: nomor_telepon, saldo: saldo }, function(response) {
        //     alert(response); // Tampilkan respons dari server (berhasil atau gagal)
        // });

        // Untuk contoh sederhana, kita hanya menampilkan data yang diambil dari form
        var newData = "<tr><td>" + nama_nasabah + "</td><td>" + alamat + "</td><td>" + email + "</td><td>" + nomor_telepon + "</td><td>Rp " + saldo + "</td></tr>";
        document.getElementById('dataNasabah').innerHTML += newData;

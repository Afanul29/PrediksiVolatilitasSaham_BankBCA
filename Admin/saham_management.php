    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <a href="tambah_saham.php" class="btn btn-success">Tambah</a>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td>{$row['TANGGAL']}</td>
                            <td>{$row['HARGA_PENUTUP']}</td>
                            <td>{$row['HARGA_PEMBUKA']}</td>
                            <td>{$row['HARGA_TERTINGGI']}</td>
                            <td>{$row['HARGA_TERENDAH']}</td>
                            <td>{$row['PERUBAHAN']}%</td>
                            <td>{$row['VOLUME']}</td>
                            <td>
                              <a href='edit_saham.php?id=" . $row['ID_SAHAM'] . "' class='mr-3'><i class='fas fa-edit'></i></a>
                               <a href='hapus_saham.php?id=" . $row['ID_SAHAM'] . "' class='text-danger ml-2'><i class='fas fa-trash'></i></a>
                            </td>
                          </tr>";
                }

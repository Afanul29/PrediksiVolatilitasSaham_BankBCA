...
// Ambil parameter halaman untuk menentukan data yang ditampilkan
...
$sql = "SELECT * FROM history_transaksi LIMIT $limit OFFSET $offset";
...
if (mysqli_num_rows($result) > 0) {
    // Output data dalam bentuk tabel HTML
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>".$row["ID_TRANSAKSI"]."</td>";
        echo "<td>".$row["ID_NASABAH"]."</td>";
        echo "<td>".$row["ID_SAHAM"]."</td>";
        echo "<td>".$row["TANGGAL_TRANSAKSI"]."</td>";
        echo "<td>".$row["JUMLAH_BELI_SAHAM"]." Lot</td>";

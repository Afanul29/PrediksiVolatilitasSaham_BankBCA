...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $username_nasabah = $_POST['USERNAME_NASABAH'];
    $password_nasabah = $_POST['PASSWORD_NASABAH'];
    ...
    // Query untuk memperbarui data nasabah
    ...
    if (mysqli_query($koneksi, $query)) {
        $_SESSION['pesan_sukses'] = "Data nasabah berhasil diperbarui.";
        exit;
    } else {
    ...
    // Query untuk mengambil data nasabah berdasarkan ID
...
?>
 ...
 <form method="post" action="">
        ...
        <div class="form-group">
            <label for="USERNAME_NASABAH">Username:</label>
            <input type="text" id="USERNAME_NASABAH" name="USERNAME_NASABAH" class="form-control" value="<?php echo $row['USERNAME_NASABAH']; ?>" required>
        </div>
        <div class="form-group">
            <label for="PASSWORD_NASABAH">Password:</label>
            <input type="password" id="PASSWORD_NASABAH" name="PASSWORD_NASABAH" class="form-control" value="<?php echo $row['PASSWORD_NASABAH']; ?>" required>
        </div>
        <div class="form-group">
            <label for="NAMA_NASABAH">Nama:</label>
            <input type="text" id="NAMA_NASABAH" name="NAMA_NASABAH" class="form-control" value="<?php echo $row['NAMA_NASABAH']; ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" id="NOMER_TELEPON" name="NOMER_TELEPON" class="form-control" value="<?php echo $row['NOMER_TELEPON']; ?>" required>
        </div>
        <div class="form-group">
            <label for="SALDO">Saldo:</label>
            <input type="number" id="SALDO" name="SALDO" class="form-control" value="<?php echo $row['SALDO']; ?>" required>
        </div>
